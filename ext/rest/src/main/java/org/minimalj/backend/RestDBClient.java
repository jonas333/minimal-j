...
public final class RestDBClient {
    ...
    private final String BASE_URI = "https://sandbox-2e88.restdb.io/rest/"; // change to your BASE URI
    private final String API_KEY = "582467c624e1ccd28187b36b329ca48cc2a89"; // change to your API KEY
    ...
    private void sentPostRequest(final HttpURLConnection connection, final String parameters) throws IOException {
    	connection.getOutputStream().write(parameters.getBytes(Charset.forName("UTF-8")));
//    	

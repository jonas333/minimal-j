...
public class SwingResourceHelper extends ResourceHelper {
	...
	private static KeyStroke getKeyStroke(ResourceBundle resourceBundle, String key) {
	...
	private static Integer getKeyCode(ResourceBundle resourceBundle, String key) {
		String keyStrokeString = getStringOptional(resourceBundle, key);
		if (!StringUtils.isBlank(keyStrokeString)) {

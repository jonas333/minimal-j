...
public class CrossTable extends SubTable {

	public CrossTable(SqlPersistence sqlPersistence, String prefix, Class clazz, PropertyInterface idProperty) {
	...
	public void insert(Object parentId, List objects) throws SQLException {
		try (PreparedStatement insertStatement = createStatement(sqlPersistence.getConnection(), insertQuery, false)) {
			for (int position = 0; position<objects.size(); position++) {
				Object element = objects.get(position);

...
public class HistorizedCrossTable extends HistorizedSubTable {

	public HistorizedCrossTable(SqlPersistence sqlPersistence, String prefix, Class viewClass, PropertyInterface idProperty) {

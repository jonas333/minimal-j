 ...
 */
public class HistorizedCrossTable<PARENT, ELEMENT> extends HistorizedSubTable<PARENT, ELEMENT> implements ListTable<PARENT, ELEMENT> {

	public HistorizedCrossTable(SqlRepository sqlRepository, String name, Class<ELEMENT> clazz, PropertyInterface idProperty) {
	...
	protected String insertQuery() {
		...
		s.append(" (elementId, id, startVersion, endVersion, position) VALUES (?, ?, 0, " + Integer.MAX_VALUE + ", ?, ?)");
		return s.toString();
	}
